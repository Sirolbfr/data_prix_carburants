...
| ------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Titre du jeu                                      | Prix des carburants en France — flux instantané                                              |
| Producteur                                        | Ministères économiques et financiers                                                         |
| URL                                               | https://www.data.gouv.fr/datasets/prix-des-carburants-en-france-flux-instantane-v2-amelioree |
| Licence                                           | Open Licence version 2.0                                                                     |
| Date de dernière mise à jour                      | 18/09/26                                                                                     |
| Fréquence de mise à jour                          | Quotidienne                                                                                  |
| Couverture géographique et temporelle             | Métropole + Corse<br>Depuis le 7 mars 2023                                                   |
